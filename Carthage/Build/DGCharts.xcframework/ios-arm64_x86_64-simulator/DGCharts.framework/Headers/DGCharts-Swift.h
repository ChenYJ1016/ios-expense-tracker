...
@property (nonatomic, copy) NSArray<ChartHighlight *> * _Nonnull highlighted;
...
@interface UIPanGestureRecognizer (SWIFT_EXTENSION(DGCharts))
...
@interface UIPinchGestureRecognizer (SWIFT_EXTENSION(DGCharts))
@property (nonatomic) CGFloat nsuiScale;
- (CGPoint)nsuiLocationOfTouch:(NSInteger)touch inView:(UIView * _Nullable)inView SWIFT_WARN_UNUSED_RESULT;
@end

@interface UIRotationGestureRecognizer (SWIFT_EXTENSION(DGCharts))
@property (nonatomic) CGFloat nsuiRotation;
@end

@interface UIScreen (SWIFT_EXTENSION(DGCharts))
@property (nonatomic, readonly) CGFloat nsuiScale;
@end

@interface UIScrollView (SWIFT_EXTENSION(DGCharts))
@property (nonatomic) BOOL nsuiIsScrollEnabled;
@end

@interface UITapGestureRecognizer (SWIFT_EXTENSION(DGCharts))
- (NSInteger)nsuiNumberOfTouches SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic) NSInteger nsuiNumberOfTapsRequired;
@end

@interface UIView (SWIFT_EXTENSION(DGCharts))
